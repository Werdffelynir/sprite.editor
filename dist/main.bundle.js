...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.css */ \"./src/components/main.css\");\n/* harmony import */ var _main_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main.html */ \"./src/components/main.html\");\n/* harmony import */ var lib_src_components_Graphic_Tileset__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lib/src/components/Graphic/Tileset */ \"./node_modules/lib/src/components/Graphic/Tileset.js\");\n/* harmony import */ var lib_src_static__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lib/src/static */ \"./node_modules/lib/src/static/index.js\");\n/* harmony import */ var lib_src_static_positionMouse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lib/src/static/positionMouse */ \"./node_modules/lib/src/static/positionMouse.js\");\n/* harmony import */ var _CanvasSelector__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CanvasSelector */ \"./src/components/CanvasSelector.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\nfunction _toPropertyKey(arg) { var key = _toPrimitive(arg, \"string\"); return _typeof(key) === \"symbol\" ? key : String(key); }\nfunction _toPrimitive(input, hint) { if (_typeof(input) !== \"object\" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || \"default\"); if (_typeof(res) !== \"object\") return res; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (hint === \"string\" ? String : Number)(input); }\nfunction _classPrivateFieldInitSpec(obj, privateMap, value) { _checkPrivateRedeclaration(obj, privateMap); privateMap.set(obj, value); }\nfunction _checkPrivateRedeclaration(obj, privateCollection) { if (privateCollection.has(obj)) { throw new TypeError(\"Cannot initialize the same private elements twice on an object\"); } }\nfunction _classPrivateFieldGet(receiver, privateMap) { var descriptor = _classExtractFieldDescriptor(receiver, privateMap, \"get\"); return _classApplyDescriptorGet(receiver, descriptor); }\nfunction _classApplyDescriptorGet(receiver, descriptor) { if (descriptor.get) { return descriptor.get.call(receiver); } return descriptor.value; }\nfunction _classPrivateFieldSet(receiver, privateMap, value) { var descriptor = _classExtractFieldDescriptor(receiver, privateMap, \"set\"); _classApplyDescriptorSet(receiver, descriptor, value); return value; }\nfunction _classExtractFieldDescriptor(receiver, privateMap, action) { if (!privateMap.has(receiver)) { throw new TypeError(\"attempted to \" + action + \" private field on non-instance\"); } return privateMap.get(receiver); }\nfunction _classApplyDescriptorSet(receiver, descriptor, value) { if (descriptor.set) { descriptor.set.call(receiver, value); } else { if (!descriptor.writable) { throw new TypeError(\"attempted to set read only private field\"); } descriptor.value = value; } }\n\n\n\n\n\n\nvar _root = /*#__PURE__*/new WeakMap();\nvar _html = /*#__PURE__*/new WeakMap();\nvar MainComponent = /*#__PURE__*/function () {\n  function MainComponent(state) {\n    _classCallCheck(this, MainComponent);\n    /** @type {HTMLElement} */\n    _classPrivateFieldInitSpec(this, _root, {\n      writable: true,\n      value: void 0\n    });\n    /** @type {HTMLElement} */\n    _classPrivateFieldInitSpec(this, _html, {\n      writable: true,\n      value: void 0\n    });\n    /** @type {CanvasRenderingContext2D} */\n    _defineProperty(this, \"context\", void 0);\n    _defineProperty(this, \"elements\", {\n      control: null,\n      tile_w: null,\n      tile_h: null,\n      size_w: null,\n      size_h: null,\n      resize_w: null,\n      resize_h: null,\n      file: null,\n      ico_file: null,\n      withnumber: null,\n      onsplit: null,\n      color: null,\n      onalpha: null,\n      tile: null,\n      canvas: null,\n      tiles: null,\n      selectable: null,\n      selectFromX: null,\n      selectFromY: null,\n      selectToX: null,\n      selectToY: null,\n      selectCopyBtn: null,\n      selectSizeWidth: null,\n      selectSizeHeight: null\n    });\n    _defineProperty(this, \"selectPartOn\", false);\n    _defineProperty(this, \"loadedImage\", null);\n    _classPrivateFieldSet(this, _root, state.elements.root);\n    _classPrivateFieldSet(this, _html, document.createRange().createContextualFragment(_main_html__WEBPACK_IMPORTED_MODULE_1__[\"default\"]).firstElementChild);\n    this.elements = lib_src_static__WEBPACK_IMPORTED_MODULE_3__[\"default\"].searchAttr('data-id', _classPrivateFieldGet(this, _html));\n    this.context = this.elements.canvas.getContext(\"2d\", {\n      willReadFrequently: true\n    });\n    this.memory = {};\n  }\n  _createClass(MainComponent, [{\n    key: \"_bindEvents\",\n    value: function _bindEvents() {}\n  }, {\n    key: \"render\",\n    value: function render() {\n      _classPrivateFieldGet(this, _root).append(_classPrivateFieldGet(this, _html));\n      this.uploadFile();\n      this.splitSprite();\n      this.alphaSprite();\n      this.selectableFx();\n    }\n  }, {\n    key: \"sprite2base64\",\n    value: function sprite2base64(tiles) {\n      var _this = this;\n      tiles.addEventListener('click', function (event) {\n        var tile = event.srcElement;\n        if (tile instanceof HTMLCanvasElement) {\n          _this.elements.base64.textContent = tile.toDataURL();\n        }\n      });\n    }\n  }, {\n    key: \"toString\",\n    value: function toString() {\n      return 'MainComponent';\n    }\n  }, {\n    key: \"uploadFile\",\n    value: function uploadFile() {\n      var _this2 = this;\n      this.elements['ico_file'].addEventListener('click', function () {\n        return _this2.elements['file'].click();\n      });\n      this.elements['file'].onchange = function (evt) {\n        var files = evt.target.files;\n        if (FileReader && files && files.length) {\n          var fileReader = new FileReader();\n          fileReader.onload = function () {\n            var img = new Image();\n            img.onload = function () {\n              _this2.loadedImage = img;\n              _this2.context.canvas.width = img.width;\n              _this2.context.canvas.height = img.height;\n              _this2.elements.tile_w.value = img.width;\n              _this2.elements.tile_h.value = img.height;\n              _this2.context.drawImage(img, 0, 0);\n            };\n            img.src = fileReader.result;\n          };\n          fileReader.readAsDataURL(files[0]);\n        }\n      };\n    }\n  }, {\n    key: \"selectableFx\",\n    value: function selectableFx() {\n      var _this3 = this;\n      var inputs = [this.elements.selectFromX, this.elements.selectFromY, this.elements.selectToX, this.elements.selectToY, this.elements.selectSizeWidth, this.elements.selectSizeHeight];\n      inputs.forEach(function (inp) {\n        inp.addEventListener('change', function (event) {\n          if (!_this3.selector) return;\n          var tar = event.target;\n          var id = tar.getAttribute('data-id');\n          if (id === 'selectFromX') {\n            _this3.selector.start.x = tar.value;\n          }\n          if (id === 'selectFromY') {\n            _this3.selector.start.y = tar.value;\n          }\n          if (id === 'selectToX') {\n            _this3.selector.end.x = tar.value;\n          }\n          if (id === 'selectToY') {\n            _this3.selector.end.y = tar.value;\n          }\n          if (_this3.copyCanvas && id === 'selectSizeWidth' || id === 'selectSizeHeight') {\n            var copyTile = new lib_src_components_Graphic_Tileset__WEBPACK_IMPORTED_MODULE_2__[\"default\"](_this3.copyCanvas, _this3.copyCanvas.width, _this3.copyCanvas.height);\n            // let width = this.memory.width,\n            //     height = this.memory.height;\n            if (id === 'selectSizeWidth') _this3.memory.width = parseInt(tar.value);\n            if (id === 'selectSizeHeight') _this3.memory.height = parseInt(tar.value);\n            // if (!this.memory.width) this.memory.width = this.copyCanvas.width;\n            // if (!this.memory.height) this.memory.height = this.copyCanvas.height;\n            _this3.copyCanvas = copyTile.resize(_this3.copyCanvas, _this3.memory.width, _this3.memory.height);\n            _this3.elements.tiles.textContent = '';\n            _this3.elements.tiles.appendChild(_this3.copyCanvas); // вставляємо для тесту\n            _this3.elements.base64.textContent = '';\n            _this3.sprite2base64(_this3.copyCanvas);\n          }\n        });\n      });\n      this.elements.selectCopyBtn.addEventListener('click', function (event) {\n        if (!_this3.selector) return;\n        _this3.copyCanvas = _this3.selector.copySelectionToNewCanvas();\n        if (_this3.copyCanvas) {\n          // if (!this.memory.width) this.memory.width = this.copyCanvas.width;\n          // if (!this.memory.height) this.memory.height = this.copyCanvas.height;\n\n          _this3.memory.width = _this3.copyCanvas.width;\n          _this3.memory.height = _this3.copyCanvas.height;\n          _this3.elements.selectSizeWidth.value = _this3.memory.width;\n          _this3.elements.selectSizeHeight.value = _this3.memory.height;\n\n          // if (this.memory.width !== this.copyCanvas.width || this.memory.height !== this.copyCanvas.height) {\n          //     const copyOfCopy = new Tileset(this.copyCanvas, this.copyCanvas.width, this.copyCanvas.height)\n          //     this.copyCanvas = copyOfCopy.resize(this.copyCanvas, this.memory.width, this.memory.height);\n          // }\n\n          _this3.elements.tiles.textContent = '';\n          _this3.elements.tiles.appendChild(_this3.copyCanvas); // вставляємо для тесту\n          _this3.elements.base64.textContent = '';\n          _this3.sprite2base64(_this3.copyCanvas);\n        }\n      });\n      this.elements.selectable.addEventListener('change', function (event) {\n        _this3.selectPartOn = event.target.checked;\n        if (_this3.selectPartOn && _this3.loadedImage) {\n          _this3.selectStart();\n        } else {\n          _this3.selectRemove();\n          event.target.checked = false;\n        }\n      });\n    }\n  }, {\n    key: \"selectStart\",\n    value: function selectStart() {\n      var _this$elements = this.elements,\n        selectFromX = _this$elements.selectFromX,\n        selectFromY = _this$elements.selectFromY,\n        selectToX = _this$elements.selectToX,\n        selectToY = _this$elements.selectToY;\n      this.selector = new _CanvasSelector__WEBPACK_IMPORTED_MODULE_5__.CanvasSelector(this.elements.canvas);\n      this.selector.mousemoves.add(function (start, end) {\n        selectFromX.value = start.x;\n        selectFromY.value = start.y;\n        selectToX.value = end.x;\n        selectToY.value = end.y;\n      });\n    }\n  }, {\n    key: \"selectRemove\",\n    value: function selectRemove() {\n      this.selector.destroy();\n    }\n  }, {\n    key: \"splitSprite\",\n    value: function splitSprite() {\n      var _this4 = this;\n      this.elements.onsplit.addEventListener('click', function () {\n        var tile = new lib_src_components_Graphic_Tileset__WEBPACK_IMPORTED_MODULE_2__[\"default\"](_this4.elements.canvas, parseInt(_this4.elements.size_w.value), parseInt(_this4.elements.size_h.value));\n        var sprites = tile.debug_sprite_list(_this4.elements.withnumber.checked);\n        _this4.elements.tiles.textContent = '';\n        sprites.forEach(function (sprite) {\n          _this4.elements.tiles.append(tile.resize(sprite, parseInt(_this4.elements.resize_w.value), parseInt(_this4.elements.resize_h.value)));\n        });\n        _this4.sprite2base64(_this4.elements.tiles);\n      });\n    }\n  }, {\n    key: \"alphaSprite\",\n    value: function alphaSprite() {\n      var _this5 = this;\n      var canvas = this.elements.canvas;\n      var px = null;\n      canvas.addEventListener('click', function (event) {\n        var pos = (0,lib_src_static_positionMouse__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(event);\n        px = _this5.context.getImageData(pos.x, pos.y, 1, 1);\n        _this5.elements.x.textContent = parseInt(pos.x);\n        _this5.elements.y.textContent = parseInt(pos.y);\n        var color = \"rgba(\".concat(px.data[0], \", \").concat(px.data[1], \", \").concat(px.data[2], \", \").concat(px.data[3], \")\");\n        lib_src_static__WEBPACK_IMPORTED_MODULE_3__[\"default\"].stylizer(_this5.elements.color, {\n          backgroundColor: color\n        });\n        _this5.elements.color_rgb.textContent = color;\n      });\n      this.elements['onalpha'].addEventListener('click', function () {\n        var idata = _this5.context.getImageData(0, 0, canvas.width, canvas.height);\n        for (var i = 0; i < idata.data.length; i += 4) {\n          if (idata.data[i + 0] === px.data[0] && idata.data[i + 1] === px.data[1] && idata.data[i + 2] === px.data[2]) {\n            idata.data[i + 3] = 0;\n          }\n        }\n        _this5.context.putImageData(idata, 0, 0);\n      });\n    }\n  }]);\n  return MainComponent;\n}();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MainComponent);\n\n//# sourceURL=webpack://wp_blank/./src/components/MainComponent.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("9dde04f8bd849d1076f6")
/******/ 	})();
/******/ 	
